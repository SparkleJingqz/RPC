...
import Server.HelloServiceImpl.HelloServiceImpl;
...
//        ByeService byeService = new Bye2Impl();
        NettyServer server = new NettyServer("127.0.0.1", 9999, SerializerCode.KRYO.getCode(), BalancerType.ROUND.getCode());
